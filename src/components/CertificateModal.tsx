                      ...
                      `}>
                        ...
                        `}>
                              ...
                              <>
                                ...
                                <div className="absolute top-3 left-1/2 -translate-x-1/2 md:top-6 w-full flex justify-center">
                                  ...
                                  >
                                    ...
                                    <span className="text-[8px] md:text-[10px] font-bold text-[#bfdbfe] uppercase tracking-[0.2em] whitespace-nowrap">22世纪见证者</span>
                                  </motion.div>
                                </div>
                              </>
                            )}
                            ...
                            <div className="mb-2 md:mb-8 w-full overflow-hidden">
                              ...
                              `}>
                                {allCertificates[currentCertificateIndex].isCenturyTraveler ? '世纪旅人·时间守护者证书' : '时间守护者证书'}
                              </h2>
                              ...
                              `}>
                                {allCertificates[currentCertificateIndex].isCenturyTraveler ? 'Century Traveler Authentication' : '时间守护者证书'}
                              </p>
                            </div>
                            ...
                            <div className="space-y-3 md:space-y-4 mb-4 md:mb-8 relative z-10">
                              ...
                              <p className={`leading-relaxed max-w-none mx-auto text-xs md:text-sm transition-colors duration-1000 ${allCertificates[currentCertificateIndex].isCenturyTraveler ? 'text-[rgba(219,234,254,0.8)]' : 'text-[#57534e]'}`}>
                                ...
                                {allCertificates[currentCertificateIndex].isCenturyTraveler ? (
                                  <>该时间胶囊已进入<span className="text-[#60a5fa] font-bold">“世纪航线”</span>，并将于 <span className="text-[#60a5fa] font-bold">{allCertificates[currentCertificateIndex].arrivalYear}</span> 年准时开启。</>
                                ) : (
                                  <>该时间胶囊已进入永恒轨道，并将于 <span className="text-[#1c1917] font-bold">{allCertificates[currentCertificateIndex].arrivalYear}</span> 年准时开启。</>
                                )}
                              </p>
                              ...
                              <p className={`italic text-[10px] md:text-xs transition-colors duration-1000 ${allCertificates[currentCertificateIndex].isCenturyTraveler ? 'text-[rgba(96,165,250,0.6)]' : 'text-[#78716c]'}`}>
                                {allCertificates[currentCertificateIndex].isCenturyTraveler ? '“跨越世纪的曙光，只为遇见未来的自己。”' : '“时光流转，承诺的温度永恒。”'}
                              </p>
                            </div>
                            ...
                            <div className="w-full relative flex justify-between items-center mt-1 md:mt-2 min-h-[60px] md:min-h-[90px]">
                              ...
                              <div className="text-right flex flex-col gap-3 md:gap-4 min-w-[120px]">
                                ...
                                <div>
                                  <p className="text-[8px] md:text-[9px] text-[#a8a29e] uppercase tracking-widest font-bold mb-0.5 md:mb-1 whitespace-nowrap">颁发日期</p>
